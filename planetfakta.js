...
planets.forEach(planet => planet.style.backgroundImage = `url(${planet.dataset.img})`);
...
const planetFacts = {
  ...
  "Jorden": { "Temperatur": "Ständigt stigande medeltemperatur på ca 15°C", "Storlek": "Diameter 12 742 km", "Miljö": "Atmosfären består mest av kväve och syre. Har en skyddande mantel med naturlig växthuseffekt", "Övrig fakta": "Kallas 'den blå planeten' då ytan består av 70% vatten. Är inte en perfekt sfär utan en ellips. Enda planeten där vi vet att liv existerar" },
  "Mars": { "Temperatur": "Genomsnittlig temperatur runt ca -60°C. Under vintern vid polerna kan den gå ner till -150°C", "Storlek": "Diameter 6 779 km (Jorden: 12 742 km)", "Miljö": "Består av ca 95% koldioxid. Har en tunn atmosfär utan ett magnetfält. Rymdsonder har bevisat att det har funnits flytande vatten på planeten", "Övrig fakta": "Känd som 'den röda planeten' då atmosfären är fylld av röda partiklar från dess järnoxid" },
  ...
  "Saturnus": { "Temperatur": "Ca -140°C runt molntopparna med en stigande temperatur in mot atmosfären runt ca 300°C", "Storlek": "Diameter 120 500 km (Jorden: 12 742 km)", "Miljö": "En gasplanet med lägst densitet i solsystemet. Består huvudsakligen av väte och helium. Extrema vindar som når ca 500 m/s", "Övrig fakta": "Känd för sina ringar som består av mest vattenis och stenpartiklar. Det regnar diamanter då det omvandlade kolet som faller hårdnar i atmosfären" },
  "Uranus": { "Temperatur": "De kalla vindarna ger temperaturer på omkring -195°C/-224°C", "Storlek": "Diameter 51 118 km (Jorden: 12 742 km)", "Miljö": "En isjätte med atmosfärer av väte, helium, ammoniak och metan. Då metangasen absorberar rött ljus uppenbarar sig planeten blå-grön", "Övrig fakta": "Roterar på sidan då dess axel har en lutning på omkring 98°. Liksom Saturnus har planeten ringar omkring sig" },
